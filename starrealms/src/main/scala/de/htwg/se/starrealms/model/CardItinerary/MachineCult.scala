...
class MachineCult(
    override val name: String = "Machine Cult",
    override val cardType: CardType = new Base,
    override val faction: Option[Faction] = Some(Faction("Machine Cult")),
    override val cost: Option[Int] = Some(3),
    override val defense: Option[String] = Some("2"),
    override val primaryAbility: Option[Ability] = Some(new Ability("Scrap a card from your hand or discard pile.")),
    override val allyAbility: Option[Ability] = Some(new Ability("Scrap a card from your hand or discard pile.")),
  ...
  override def toString: String = {
    s"MachineCult: $name, Cost: $cost, Defense: $defense, " +
